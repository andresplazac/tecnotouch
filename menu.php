...
<ul id="nav">
	<li class="top"><a href="index.php" class="top_link"><span>Inicio</span></a></li>
        <li class="top"><a href="quienesSomos.php" class="top_link"><span>Quienes Somos</span></a></li>
        <li class="top"><a href="contacto.php" class="top_link"><span>Contacto</span></a></li>
        <li class="top"><a href="comoLlegar.php" class="top_link"><span>Cómo Llegar</span></a></li>
        <li class="top"><a href="verCarro.php" class="top_link"><span>Ver Carro</span></a></li>
